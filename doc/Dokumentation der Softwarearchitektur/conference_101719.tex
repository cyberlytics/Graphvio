...
von einem Subteam entwickelt wird. Diese gekapselten Einheiten können jeweils als insolierte Applikation im Containervisualisierer
Docker betrieben werden.
Backend ...
Die Interaktion der Logikkomponenten erfolgt über Schnittstellen (REST), die im Frontend aufgerufen werden.
